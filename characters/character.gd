...
var phrases = {
	...
	"shark": {
		"phrases": [
			[  # 1
"Хороший руководитель должен быть как акула — всегда в движении, всегда голоден",
	"Говорят, я требовательный. Я просто требую, чтобы все было идеально. Разве это плохо?",
	"На моем столе нет лишних бумаг. Как и в моей жизни — нет лишних сотрудников",
			],
			[  # 2
 "Вы тратите больше времени на поиск оправданий, чем на работу. Это надо исправить",
	"Пока вы парите в облаках, конкуренты выклевывают наш рынок. Идите работать!",
	"Я — живое доказательство того, что можно перегрызть глотку любому конкуренту.",
			],
			[  # 3
 "Мой костюм стоит больше, чем ваш автомобиль. Потому что я — актив компании",
	"Это не жестокость. Это естественный отбор в корпоративной экосистеме.",
	"Каждая моя секунда стоит дороже вашего часа.",
			],
			[  # 4
 "Вы пытались подсчитать мой доход? Мило. Я и сам иногда теряю нули",
	"Ваше благополучие — мой приоритет! Поэтому я плачу ровно столько, чтобы вы не уволились",
	"Комфорт — моя забота! Этот новый жесткий стул, чтобы вы не засыпали на работе",
			],
			[  # 5
 "Вы можете позволить себе слабость. А я должен быть идеальным. Всегда…",
	"Зачем быть высоким, если можно быть недосягаемым?",
    "За каждым успехом стоит титанический труд. Мой титанический труд над вами"
			]
		],
		"side": ArrowSide.LEFT
	},

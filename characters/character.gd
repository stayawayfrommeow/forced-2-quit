...
var phrases = {
	"ant": {
		"phrases": [
			[  # 1
				...
				"Я не избегаю общения. Я экономлю энергию для драгоценных моментов залипания в стену.",
				"Моя душа уже ушла с работы, а тело осталось, потому что у него есть кредит."
			],
			[  # 2
			...
			[  # 4
				"Иногда мне кажется, что я — муравей в гигантском муравейнике, где все друг друга ненавидят, но делают вид, что строят общее гнездо.",
				"Я уже не помню, какое хобби у меня было. Кажется, это был сон.",
				"Я не ищу смысла. Я ищу очередную чашку кофе."
			],
			[  # 5
				"Мне сказали, что срочная задача, которую нужно было сделать “еще вчера”, будет ждать согласования две недели.",
				"Фраза “гибкий график” означает, что твой график гибко подстраивается под нужды компании.",
	...
	"shark": {
		"phrases": [
			[  # 1
				...
				"Говорят, я требовательный. Я просто требую, чтобы все было идеально. Разве это неправильно?",
			...
			[  # 2
				...
				"Я не просто начальник. Я — живое доказательство того, что можно перегрызть глотку любому конкуренту. В переносном смысле, конечно."
			],
			[  # 3
				"Мой костюм стоит больше, чем ваш автомобиль. Потому что я — актив, а вы — расходы на зарплату.",
				"Мои решения кажутся вам жестокими? Это не жестокость. Это естественный отбор в корпоративной экосистеме.",
				"Мои письма приходят с пометкой «СРОЧНО», потому что каждая секунда моего ожидания стоит дороже вашего часа."
			],
			[  # 4
				"Вы пытались подсчитать мой доход? Мило. Я и сам иногда теряю нули.",
				"Ваше благополучие — мой приоритет! Именно поэтому я плачу вам ровно столько, чтобы вы не уволились.",
				"Ваш комфорт — моя забота! Видите этот новый жесткий стул? Он специально, чтобы вы не засыпали на работе."
			],
			[  # 5
				"Вы можете позволить себе слабость. А я должен быть идеальным. Всегда. Это истощает, поверьте.",
				"Зачем быть высоким, если можно быть недосягаемым?",
				"За каждым моим успехом стоит титанический труд. В основном, мой титанический труд над вами."
			]
		],
		"side": ArrowSide.LEFT
	},
	...
	"fox": {
		"phrases":  [
			...
			[  # 3
				"Я не просто сижу за стойкой. Я формирую первое впечатление о компании. Жаль, что ваше присутствие его портит",
	...
	"barsik": {
		"phrases": [
			[  # 1
				...
				"Не загораживайте мне вид. Вы мешаете обзору моего будущего кабинета.",
